...
$listBox.Height = 240
$listBox.Width  = 300
[void] $listBox.Items.Add('-------- A01 --------')
[void] $listBox.Items.Add('Corporate-NL')
[void] $listBox.Items.Add('Corporate-BE')
[void] $listBox.Items.Add('Corporate-PT')
[void] $listBox.Items.Add('Corporate-PH')
[void] $listBox.Items.Add('Corporate-DK')
