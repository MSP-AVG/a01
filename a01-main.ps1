...
iex (irm https://raw.githubusercontent.com/MSP-AVG/a01/refs/heads/main/a01-ap-menu.ps1)

Write-Host -Foreground Red $GroupTag
sleep -Seconds 3

iex (irm https://raw.githubusercontent.com/MSP-AVG/a01/refs/heads/main/a01-functions.ps1)
...
if($GroupTag -eq 'Corporate-BE'){Dism /image:C:\ /Set-InputLocale:0813:00000813}
...
if($GroupTag -eq 'Corporate-NL'){Dism /image:C:\ /Set-InputLocale:0413:00020409}
